        ...
        <div className="col-lg-5 col-12 right-content">
          ...
          {ctas?.map((cta, index) => (
            cta.url ? (
              ...
              >
                {index === 0 && (
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ticket" class="svg-inline--fa fa-ticket" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" style={{ marginTop: "-2px", marginRight: "4px", fontSize: "12px", width: "16px", height: "12px" }}>
